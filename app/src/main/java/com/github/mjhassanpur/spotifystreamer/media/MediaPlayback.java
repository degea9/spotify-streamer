 ...
 *
 * @see <a href="https://github.com/googlesamples/android-UniversalMusicPlayer/blob/master/mobile/src/main/java/com/example/android/uamp/LocalPlayback.java"></a>
 */
public class MediaPlayback implements Playback, AudioManager.OnAudioFocusChangeListener,
        OnCompletionListener, OnErrorListener, OnPreparedListener, OnSeekCompleteListener {

    private static final String TAG = LogHelper.makeLogTag(MediaPlayback.class);
    ...
    // We don't have audio focus, but can duck (play at a low volume)
    ...
    private volatile int mCurrentStreamPosition;
    ...
    public MediaPlayback(MusicService service, MediaProvider mediaProvider) {
        mService = service;
    ...
    public void stop(boolean notifyListeners) {
        ...
        mCurrentStreamPosition = getCurrentStreamPosition();
        giveUpAudioFocus();
    ...
    public int getCurrentStreamPosition() {
        return mMediaPlayer != null ?
                mMediaPlayer.getCurrentPosition() : mCurrentStreamPosition;
    }
    ...
    public void play(QueueItem item) {
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED && !mediaHasChanged && mMediaPlayer != null) {
            ...
            MediaMetadataCompat track = mMediaProvider.getMusic(item.getDescription().getMediaId());
    ...
    public void pause() {
        if (mState == PlaybackStateCompat.STATE_PLAYING) {
            ...
            if (mMediaPlayer != null && mMediaPlayer.isPlaying()) {
                mMediaPlayer.pause();
                mCurrentStreamPosition = mMediaPlayer.getCurrentPosition();
            }
        ...
        if (mAudioFocus == AUDIO_NO_FOCUS_NO_DUCK) {
            ...
            if (mPlayOnFocusGain) {
                if (mMediaPlayer != null && !mMediaPlayer.isPlaying()) {
                    ...
                    if (mCurrentStreamPosition == mMediaPlayer.getCurrentPosition()) {
                        mMediaPlayer.start();
                        mState = PlaybackStateCompat.STATE_PLAYING;
                    } else {
                        mMediaPlayer.seekTo(mCurrentStreamPosition);
                        mState = PlaybackStateCompat.STATE_BUFFERING;
                    }
                }
    ...
    public void onSeekComplete(MediaPlayer mp) {
        ...
        mCurrentStreamPosition = mp.getCurrentPosition();
